...
public class RankingService {
    ...
    private static final String USUARIO_SERVICE_URL = "https://app-matematica-gateway-a356f607c624.herokuapp.com/usuario";
    ...
    private void enriquecerComDadosUsuario(RankingDTO ranking) {
        try {
            ...
            String alunoUrl = USUARIO_SERVICE_URL + "/estudante/" + ranking.getIdAluno();
            ...
            if (estudante != null) {
                ...
                String turmaUrl = USUARIO_SERVICE_URL + "/turma/" + estudante.getTurmaId();
